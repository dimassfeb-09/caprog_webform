...
const TableDocumentUser = (documentData?: DocumentData, npm?: string) => {
    ...
    const documentUser = (key?: string, fileName?: string) => {
        return <tr className="border-b">
            ...
            <td className="px-6 py-4">
                <a href={`${import.meta.env.VITE_URL_FIREBASE_STORAGE}/${npm}%2F${fileName}?alt=media`}
...
export default TableDocumentUser;